...
struct SString {
    ...
    static var mostRead : String {return getText(key: "mostRead")}
    ...
    private static let dicAR : [String : String] = [
        ...
        "viewAll" : "عرض الكل",
        "newBooks" : "الكتب الجديدة",
        "mostRead" : "الكتب الاكثر قراءة" ,
